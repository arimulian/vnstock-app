        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs">
                    ...
                    @foreach($categories as $i => $category)
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3 text-sm flex">
                                {{--update--}}
                                <a class="p-1" href="{{ route('category.update', $category->name) }}">
                                ...
                                {{--delete--}}
                                <button class="p-1" wire:confirm="Are You Sure?" wire:click="destroy({{$category->id}})">
            ...
            >
                <span class="flex items-center col-span-3">
                  Showing {{$categories->firstItem()}}-{{$categories->lastItem()}} of {{ $total}}
                </span>
